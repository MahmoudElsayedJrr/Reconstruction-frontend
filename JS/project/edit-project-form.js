...
export function renderForm(
    ...
    formHTML += `
      ...
      <div class="col-md-6">
        ...
        <select id="status" class="form-select">
          ...
          <option value="مسحوب" ${
            project.status === "مسحوب" ? "selected" : ""
          }>مسحوب</option>
          <option value="متوقف" ${
            project.status === "متوقف" ? "selected" : ""
          }>متوقف</option>
          <option value="يحتاج مد مده" ${
            project.status === "يحتاج مد مده" ? "selected" : ""
          }>يحتاج مد مده</option>
  ...
  if (userRole === "financial" || userRole === "admin" || userRole === "super_admin") {
    formHTML += `
  ...
  if (userRole === "admin" || userRole === "super_admin" || userRole === "projectManager") {
      ...
      <div class="col-md-6">
        ...
        <input type="date" id="assignmentOrderDate" class="form-control" value="${
          project.assignmentOrderDate
            ? new Date(project.assignmentOrderDate).toISOString().split("T")[0]
            : ""
        }">
      </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <textarea class="form-control" id="decisionName" name="decisionName" rows="1" style="min-height: 200px; resize: vertical; overflow-y: auto;"></textarea>
            </div>
            <div class="mb-3">
